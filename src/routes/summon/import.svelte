	...
	<section class="p-3 text-ms text-gray-600 border-t border-gray-300 space-y-2">
		...
		<p>
			<Translation
				...
				en="The summon history URL generated by the game will expire very soon. If you see an error, please exit the summon UI or restart the game. Then reopen summon history, retrieve the URL, and try importing it immediately."
			/>
		</p>
	</section>
</OverlayScrollbarsComponent>
